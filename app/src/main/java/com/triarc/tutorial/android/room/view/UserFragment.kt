...
import com.triarc.tutorial.android.room.adapter.UserListAdapter
...
class UserFragment: AbstractBaseFragment(), User.View, ItemClickListener {
    ...
    override fun onInitialiseView() {
        ...
        user_recycler.addItemDecoration(DividerItemDecoration(context, DividerItemDecoration.VERTICAL))
   }
